...
$result = mysqli_query($mysqli, "SELECT * FROM spec_storage order by id ");
?>
...
<body id="page-top">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["capacity"])) {
            $capaErr = "Capacity cannot be empty";
        } else {
        ...
        if (($desc != "") && ($capacity != "")) {
            ...
            $result = mysqli_query($mysqli, "INSERT INTO spec_storage (`desc`, capacity) VALUES ('$desc','$capacity')");
            // refresh the page  
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="storage.php">Storage</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form method="POST" action="<?php echo ($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <span class="error"><?php echo $capaErr; ?></span><br>
                                <input type="text" id="capacity" name="capacity" class="finput" /> <br>
                                <br>
