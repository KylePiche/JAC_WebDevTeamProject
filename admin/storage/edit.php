...
<body id="page-top">
    ...
    if (isset($_POST['update'])) { // event handler for update button
        ...
        $result = mysqli_query($mysqli, "UPDATE spec_storage SET `desc`='$desc', capacity= '$capacity' WHERE id = $id;");
        //echo $id;           
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM spec_storage WHERE id = $id");
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form name="update_user" method="POST" action="edit.php">
                                ...
                                <input type="text" id="capacity" name="capacity" class="finput"value="<?php echo $capacity; ?>"/> <br>
                                <br>
