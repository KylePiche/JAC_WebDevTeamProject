...
<body id="page-top">
    ...
    if (isset($_POST['update'])) { // event handler for update button
        ...
        $result = mysqli_query($mysqli, "UPDATE spec_memory SET `desc`='$desc', memory= '$memory' WHERE id = $id;");
        //echo $id;           
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM spec_memory WHERE id = $id");
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form name="update_user" method="POST" action="edit.php">
                                ...
                                <input type="text" id="memory" name="memory" class="finput" value="<?php echo $memory; ?>"/> <br>
                                <br>
