...
<body id="page-top">
    ...
    <?php
        ...
        if (isset($_POST['update'])) { // event handler for update button
            ...
            $result = mysqli_query($mysqli, "UPDATE spec_cpu SET `desc` = '$desc', clockSpeed= '$clock',coreCount='$core' WHERE id = $id;");           
    ...
    <?php
        ...
        $result = mysqli_query($mysqli, "SELECT * FROM spec_CPU WHERE id = $id");

        while ($user_data = mysqli_fetch_array($result)) {
            $desc = $user_data['desc'];            
            $clock = $user_data['clockSpeed'];            
            $core = $user_data['coreCount'];                    
        }
    ?>  
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form name="update_user" method="POST" action="edit.php">
                                ...
                                <input type="text" id="desc" name="desc" class="finput" value="<?php echo $desc; ?>"/> <br>
                                
                                <label for="clock">Clock Speed: </label>
                                <input type="text" id="clock" name="clock" class="finput" value="<?php echo $clock; ?>"/> <br>
                                <label for="core">Core: </label>
                                <input type="text" id="core" name="core" class="finput" value="<?php echo $core; ?>"/> <br>
