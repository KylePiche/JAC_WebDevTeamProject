...
$result = mysqli_query($mysqli, "SELECT * FROM spec_cpu order by id ");
?>
...
<body id="page-top">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["clock"])) {
            $clockErr = "Clock Speed cannot be empty";
        } else {
            $clock = $_POST["clock"];
        }
        ...
        // verify core
        if (empty($_POST["core"])) {
            $coreErr = "Core Count cannot be empty";;
        } else {
            $core = $_POST["core"];
        }
        ...
        if (($desc != "") && ($clock != "") && ($core != "")) {
            ...
            $result = mysqli_query($mysqli, "INSERT INTO spec_CPU (`desc`, clockSpeed, coreCount) VALUES ('$desc','$clock','$core')");
            // refresh the page  
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form method="POST" action="<?php echo ($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <span class="error"><?php echo $clockErr; ?></span><br>
                                <input type="text" id="clock" name="clock" class="finput" /> <br>
                                <label for="core">Core: </label>
                                <span class="error"><?php echo $coreErr; ?></span><br>
                                <input type="text" id="core" name="core" class="finput" /> <br>
                        ...
                        <table class="tblindex">
                            ...
                            while ($user_data = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>" . $user_data['clockSpeed'] . "</td>";
                                echo "<td>" . $user_data['coreCount'] . "</td>";
