...
<body id="page-top">
    ...
    if (isset($_POST['update'])) { // event handler for update button
        ...
        $result = mysqli_query($mysqli, "UPDATE spec_screen SET `desc`='$desc', size= '$size' WHERE id = $id;");
        //echo $id;           
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM spec_screen WHERE id = $id");
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="screen.php">Screen</a>
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form name="update_user" method="POST" action="edit.php">
                                ...
                                <input type="text" id="size" name="size" class="finput" value="<?php echo $size; ?>"/> <br>
                                <br>
