...
$result = mysqli_query($mysqli, "SELECT * FROM spec_screen order by id ");
?>
...
<body id="page-top">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (($desc != "") && ($size != "")) {
            ...
            $result = mysqli_query($mysqli, "INSERT INTO spec_screen (`desc`, size) VALUES ('$desc','$size')");
            // refresh the page  
                    ...
                    <div class="container">
                        ...
                        <div class="frminput">
                            <form method="POST" action="<?php echo ($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <span class="error"><?php echo $sizeErr; ?></span><br>
                                <input type="text" id="size" name="size" class="finput" /> <br>
                                <br>
